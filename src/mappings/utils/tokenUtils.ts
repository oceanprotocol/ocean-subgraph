...
const hardCodedContractData: HardCodedContractDataType = {
  ...
  '0x2d8e2267779d27c2b3ed5408408ff15d9f3a3152': {
    ...
    secondsPerEpoch: BigInt.fromI32(3600),
    secondsPerSubscription: BigInt.fromI32(86400),
    truevalSubmitTimeout: BigInt.fromI32(259200),
    stakeToken: '0x39d22b78a7651a76ffbde2aaab5fd92666aca520',
...
export function createPredictContract(address: Address): PredictContract {
  ...
  if (address.toHexString() === '0x18f54cc21b7a2fdd011bea06bba7801b280e3151') {
  ...
  if (address.toHexString() === '0x2d8e2267779d27c2b3ed5408408ff15d9f3a3152') {
  ...
  /*  
  if (
    hardCodedContractData.hasOwnProperty(address.toHexString().toLowerCase())
  ) {
    const contractData =
      hardCodedContractData[address.toHexString().toLowerCase()]
    predictContract.secondsPerEpoch = BigInt.fromI32(
      contractData.secondsPerEpoch
    )
    predictContract.secondsPerSubscription = BigInt.fromI32(
      contractData.secondsPerSubscription
    )
    predictContract.truevalSubmitTimeout = BigInt.fromI32(
      contractData.truevalSubmitTimeout
    )
